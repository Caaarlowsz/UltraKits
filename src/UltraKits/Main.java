...
import UltraKits.Warps.*;
import UltraKits.Eventos.*;
import UltraKits.Inventarios.*;
import UltraKits.Habilidades.*;
...
public class Main extends JavaPlugin implements Listener
{
    ...
    public void onEnable() {
        ...
        this.registerEvents(Main.plugin, (Listener)this, (Listener)new Warps(), (Listener)new AntiFlood(), (Listener)new Killstreak(), (Listener)new WarpsListener(), (Listener)new Pot(), (Listener)new MainList(), (Listener)new Block(), (Listener)new Earlyhg(), (Listener)new Challenge(), (Listener)new Pyro(this), (Listener)new JumpBlocks(), (Listener)new Milkman(), (Listener)new Gladiator(this), (Listener)new MuteP(), (Listener)new CommandBuild(), (Listener)new Jumper(this), (Listener)new Switcher(), (Listener)new Skit(), (Listener)new Specialist(), (Listener)new SettingsManager(), (Listener)new Placas(), (Listener)new Shooter(this), (Listener)new Endermage(this), (Listener)new WarpsListener(), (Listener)new Launcher(this), (Listener)new KitItems(), (Listener)new Events(this), (Listener)new Anchor(this), (Listener)new MenuInv(), (Listener)new Fireman(this), (Listener)new MenuInvListener(), (Listener)new Thor(this), (Listener)new Fisherman(), (Listener)new Camel(), (Listener)new Frosty(), (Listener)new Grappler(), (Listener)new Ninja(), (Listener)new Kangaroo(), (Listener)new Monk(this), (Listener)new Trocador(this), (Listener)new Tell(), (Listener)new Report(), (Listener)new Reaper(), (Listener)new Eyer(), (Listener)new Poseidon(this), (Listener)new Flash(this), (Listener)new Skeleton(this), (Listener)new Turtle(this), (Listener)new Snail(), (Listener)new Stomper(), (Listener)new Viper(), (Listener)new Darkmage(), (Listener)new Wither(), (Listener)new Soldado(this), (Listener)new Custom(), (Listener)new Desafiar(), (Listener)new UltraKits.u1v1.Events(), (Listener)new Chat(), (Listener)new Viking(), (Listener)new CombatLog(), (Listener)new Ghost(), (Listener)new SpiderMan(), (Listener)new Barbarian(), (Listener)new Berserker(), (Listener)new ServerScoreboard(), (Listener)new Indio(), (Listener)new Ryu(), (Listener)new Neji(), (Listener)new Lobisomem(), (Listener)new Granadier(), (Listener)new Rhino(), (Listener)new Phantom(), (Listener)new Alien(), (Listener)new Hulk(), (Listener)new Critical(), (Listener)new SB(), (Listener)new Vitality(), (Listener)new Admin());
        this.comandos();
    ...
    public void devolverItems() {
        if (!Commands.inv.isEmpty()) {
            for (final Map.Entry e : Commands.inv.entrySet()) {
        ...
        if (!Commands.arm.isEmpty()) {
            for (final Map.Entry e : Commands.arm.entrySet()) {
                final Player p = Bukkit.getPlayer((String)e.getKey());
                if (p != null) {
        ...
        for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
            ...
            if (Commands.em.contains(p2.getName())) {
                ...
                if (Main.data.getConfigurationSection("Saida") != null) {
                    p2.teleport(new Location(Bukkit.getWorld(Main.data.getString("Saida.world")), Main.data.getDouble("Saida.x"), Main.data.getDouble("Saida.y"), Main.data.getDouble("Saida.z"), (float)Main.data.getDouble("Saida.yaw"), (float)Main.data.getDouble("Saida.pitch")));
                }
                else {
    ...
    public void salvaStats2() {
        for (final Map.Entry e : ServerScoreboard.kills.entrySet()) {
            final String p = e.getKey();
            final Score score = e.getValue();
            Main.m.set(String.valueOf(p) + ".kills", (Object)score.getScore());
        }
        for (final Map.Entry e : ServerScoreboard.deaths.entrySet()) {
            final String p = e.getKey();
            final Score score = e.getValue();
            Main.m.set(String.valueOf(p) + ".deaths", (Object)score.getScore());
        }
        for (final Map.Entry e : ServerScoreboard.killstreak.entrySet()) {
            final String p = e.getKey();
            final Score score = e.getValue();
