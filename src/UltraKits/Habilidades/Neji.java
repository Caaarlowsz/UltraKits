...
public class Neji implements Listener
{
    ...
    public void interact(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && Main.neji.contains(p.getName()) && p.getItemInHand().equals((Object)Neji.chakra)) {
            e.setCancelled(true);
            if (!Neji.cooldown.containsKey(p.getName()) || Neji.cooldown.get(p.getName()) <= System.currentTimeMillis()) {
                if (Main.areaPvP(p)) {
                    apartaivos(p);
                ...
                p.sendMessage(ChatColor.RED + "Faltam " + TimeUnit.MILLISECONDS.toSeconds(Neji.cooldown.get(p.getName()) - System.currentTimeMillis()) + " segundos para poder usar novamente.");
            }
        }
    }
    ...
    public static void bloco(final Player p) {
        ...
        final Block b1 = l.getBlock().getRelative(BlockFace.EAST).getRelative(BlockFace.EAST).getRelative(BlockFace.NORTH);
        final Block b2 = l.getBlock().getRelative(BlockFace.EAST).getRelative(BlockFace.EAST).getRelative(BlockFace.SOUTH);
        final Block b3 = l.getBlock().getRelative(BlockFace.WEST).getRelative(BlockFace.WEST).getRelative(BlockFace.NORTH);
        final Block b4 = l.getBlock().getRelative(BlockFace.WEST).getRelative(BlockFace.WEST).getRelative(BlockFace.SOUTH);
        ...
        final Block b9 = l.getBlock().getRelative(BlockFace.SOUTH).getRelative(BlockFace.SOUTH).getRelative(BlockFace.NORTH);
        final Block b10 = l.getBlock().getRelative(BlockFace.SOUTH).getRelative(BlockFace.SOUTH).getRelative(BlockFace.SOUTH);
        final Block b11 = l.getBlock().getRelative(BlockFace.NORTH).getRelative(BlockFace.NORTH).getRelative(BlockFace.NORTH);
        final Block b12 = l.getBlock().getRelative(BlockFace.NORTH).getRelative(BlockFace.NORTH).getRelative(BlockFace.SOUTH);
