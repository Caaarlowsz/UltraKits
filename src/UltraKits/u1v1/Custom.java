...
public class Custom implements Listener
{
    ...
    static {
        ...
        Custom.inv = Bukkit.createInventory((InventoryHolder)null, 27, Main.plugin.getConfig().getString("Custom.invTitle").replaceAll("&", "§"));
        ...
        if (e.getInventory().getName().equals(Custom.inv.getName())) {
            ...
            if (e.getCurrentItem().equals((Object)Custom.done)) {
                if (Desafiar.desafiando.containsKey(p.getName())) {
                    ...
                    Desafiar.customizado.put(p.getName(), String.valueOf(Custom.armadura.get(p.getName())) + ";" + Custom.espada.get(p.getName()) + ";" + Custom.sopas.get(p.getName()));
                    ...
                    if (req != null) {
                        ...
                        for (final String b : Custom.pl.getConfig().getStringList("CustomDesafiou")) {
                            if (Custom.sopas.get(p.getName())) {
                                p.sendMessage(b.replaceAll("@armadura", Custom.armadura.get(p.getName())).replaceAll("@espada", Custom.espada.get(p.getName())).replaceAll("&", "§").replaceAll("@desafiado", req.getName()).replaceAll("@sopa", "Sim"));
                            }
                            else {
                                p.sendMessage(b.replaceAll("@armadura", Custom.armadura.get(p.getName())).replaceAll("@espada", Custom.espada.get(p.getName())).replaceAll("&", "§").replaceAll("@desafiado", req.getName()).replaceAll("@sopa", "Nao"));
                            }
                        }
                        for (final String s : Custom.pl.getConfig().getStringList("CustomConvite")) {
                            if (Custom.sopas.get(p.getName())) {
                                req.sendMessage(s.replaceAll("@armadura", Custom.armadura.get(p.getName())).replaceAll("@espada", Custom.espada.get(p.getName())).replaceAll("&", "§").replaceAll("@desafiante", p.getName()).replaceAll("@sopa", "Sim"));
                            }
                            else {
                                req.sendMessage(s.replaceAll("@armadura", Custom.armadura.get(p.getName())).replaceAll("@espada", Custom.espada.get(p.getName())).replaceAll("&", "§").replaceAll("@desafiante", p.getName()).replaceAll("@sopa", "Nao"));
                            }
                        }
                    }
                    e.setCancelled(true);
