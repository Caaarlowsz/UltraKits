...
public class Desafiar implements Listener
{
    ...
    static {
        ...
        Desafiar.gui = Bukkit.createInventory((InventoryHolder)null, Main.plugin.getConfig().getInt("1v1Slots"), Main.plugin.getConfig().getString("1v1Title").replaceAll("&", "§"));
    }
    ...
    public void desafiarPlayer(final PlayerInteractEntityEvent e) {
        ...
        if (p.getItemInHand().equals((Object)Desafiar.item) && e.getRightClicked() instanceof Player) {
            ...
            if (Desafiar.requests.containsKey(req.getName())) {
                        ...
                        if (!Desafiar.customizado.containsKey(req.getName())) {
                            if (Desafiar.kit.containsKey(req.getName())) {
                                ...
                                if (Main.kit.getConfigurationSection(id) != null) {
                                    p.getEquipment().setHelmet(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".helmet.type").toUpperCase())));
                                    req.getEquipment().setHelmet(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".helmet.type").toUpperCase())));
                                    if (Main.kit.getStringList(String.valueOf(id) + ".helmet.enchants") != null) {
                                        for (final String en : Main.kit.getStringList(String.valueOf(id) + ".helmet.enchants")) {
                                            final String[] enchant = en.split(" ");
                                            p.getEquipment().getHelmet().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                            req.getEquipment().getHelmet().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                        }
                                    }
                                    p.getEquipment().setChestplate(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".chestplate.type").toUpperCase())));
                                    req.getEquipment().setChestplate(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".chestplate.type").toUpperCase())));
                                    if (Main.kit.getStringList(String.valueOf(id) + ".chestplate.enchants") != null) {
                                        for (final String en : Main.kit.getStringList(String.valueOf(id) + ".chestplate.enchants")) {
                                            final String[] enchant = en.split(" ");
                                            p.getEquipment().getChestplate().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                            req.getEquipment().getChestplate().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                        }
                                    }
                                    p.getEquipment().setLeggings(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".leggings.type").toUpperCase())));
                                    req.getEquipment().setLeggings(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".leggings.type").toUpperCase())));
                                    if (Main.kit.getStringList(String.valueOf(id) + ".leggings.enchants") != null) {
                                        for (final String en : Main.kit.getStringList(String.valueOf(id) + ".leggings.enchants")) {
                                            final String[] enchant = en.split(" ");
                                            p.getEquipment().getLeggings().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                            req.getEquipment().getLeggings().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                        }
                                    }
                                    p.getEquipment().setBoots(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".boots.type").toUpperCase())));
                                    req.getEquipment().setBoots(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".boots.type").toUpperCase())));
                                    if (Main.kit.getStringList(String.valueOf(id) + ".boots.enchants") != null) {
                                        for (final String en : Main.kit.getStringList(String.valueOf(id) + ".boots.enchants")) {
                                            final String[] enchant = en.split(" ");
                                            p.getEquipment().getBoots().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                            req.getEquipment().getBoots().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                        }
                                    }
                                    p.getInventory().setItemInHand(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".sword.type").toUpperCase())));
                                    req.getInventory().setItemInHand(new ItemStack(Material.getMaterial(Main.kit.getString(String.valueOf(id) + ".sword.type").toUpperCase())));
                                    if (Main.kit.getStringList(String.valueOf(id) + ".sword.enchants") != null) {
                                        for (final String en : Main.kit.getStringList(String.valueOf(id) + ".sword.enchants")) {
                                            final String[] enchant = en.split(" ");
                                            p.getInventory().getItemInHand().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                            req.getInventory().getItemInHand().addUnsafeEnchantment(Enchantment.getByName(enchant[0].toUpperCase()), (int)Integer.valueOf(enchant[1]));
                                        }
                                    }
                                    if (Main.kit.getStringList(String.valueOf(id) + ".potions") != null) {
                                        for (final String pt : Main.kit.getStringList(String.valueOf(id) + ".potions")) {
                                            final String[] potion = pt.split(" ");
                                            p.addPotionEffect(new PotionEffect(PotionEffectType.getByName(potion[0].toUpperCase()), Integer.valueOf(potion[2]) * 20, Integer.valueOf(potion[1]) - 1));
                                            req.addPotionEffect(new PotionEffect(PotionEffectType.getByName(potion[0].toUpperCase()), Integer.valueOf(potion[2]) * 20, Integer.valueOf(potion[1]) - 1));
                                        }
                                    }
                                    for (int sopas = Main.kit.getInt(String.valueOf(id) + ".sopas"), i = 0; i < sopas; ++i) {
                        ...
                        new BukkitRunnable() {
                            ...
                            public void run() {
                                if (this.tempo > 1) {
                                    ...
                                    p.sendMessage(Main.plugin.getConfig().getString("Iniciando").replaceAll("&", "§").replaceAll("@tempo", new StringBuilder().append(this.tempo).toString()));
                                    req.sendMessage(Main.plugin.getConfig().getString("Iniciando").replaceAll("&", "§").replaceAll("@tempo", new StringBuilder().append(this.tempo).toString()));
                ...
                for (final Map.Entry entry : ItemManager.items.entrySet()) {
            ...
            if (ItemManager.id.containsKey(e.getCurrentItem())) {
                    ...
                    if (req != null) {
                        ...
                        for (final String msg : Main.plugin.getConfig().getStringList("Desafiou")) {
                            if (Main.kit.getString(String.valueOf(id) + ".aliase") != null) {
                                p.sendMessage(msg.replaceAll("&", "§").replaceAll("@kit", Main.kit.getString(String.valueOf(id) + ".aliase")).replaceAll("@desafiado", req.getName()));
                            }
                            else {
                        ...
                        for (final String cv : Main.plugin.getConfig().getStringList("Convite")) {
                            if (Main.kit.getString(String.valueOf(id) + ".aliase") != null) {
                                req.sendMessage(cv.replaceAll("&", "§").replaceAll("@kit", Main.kit.getString(String.valueOf(id) + ".aliase")).replaceAll("@desafiante", p.getName()));
                            }
                            else {
                ...
                for (final ItemStack i : Custom.customItem) {
                    if (e.getCurrentItem().equals((Object)i)) {
                        ...
                        Desafiar.ic = new ItemStack(Material.getMaterial(Main.plugin.getConfig().getInt("Custom.ItemRedor.id")));
