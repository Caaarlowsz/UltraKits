        ...
        if (cmd.equalsIgnoreCase("1v1")) {
            if (args.length == 0) {
                ...
                if (!Commands.em.contains(p.getName())) {
                    ...
                    final Location loc1 = new Location(Bukkit.getWorld(Main.data.getString("Spawn.world")), Main.data.getDouble("Spawn.x"), Main.data.getDouble("Spawn.y"), Main.data.getDouble("Spawn.z"), (float)Main.data.getLong("Spawn.yaw"), (float)Main.data.getLong("Spawn.pitch"));
                    p.teleport(loc1);
                    ...
                    if (Main.data.getConfigurationSection("Saida") != null) {
                        final Location loc1 = new Location(Bukkit.getWorld(Main.data.getString("Saida.world")), Main.data.getDouble("Saida.x"), Main.data.getDouble("Saida.y"), Main.data.getDouble("Saida.z"), (float)Main.data.getLong("Saida.yaw"), (float)Main.data.getLong("Saida.pitch"));
                        p.teleport(loc1);
                    }
                    else {
                ...
                if (!args[0].equalsIgnoreCase("reload") && !args[0].equalsIgnoreCase("set") && p.hasPermission("1v1.set")) {
