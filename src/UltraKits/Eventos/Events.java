...
public class Events implements Listener
{
    ...
    public void soup(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_BLOCK || e.getAction() == Action.RIGHT_CLICK_AIR) && p.getItemInHand().getType() == Material.MUSHROOM_SOUP && p.getHealth() > 0.0 && p.getHealth() < 20.0) {
    ...
    public void onPlayerLeft(final PlayerQuitEvent e) {
        ...
        for (final Map.Entry en : Events.bars.entrySet()) {
        ...
        Bukkit.getServer().broadcast(ChatColor.RED + "- " + ChatColor.RESET + p.getDisplayName() + ChatColor.RESET + ChatColor.WHITE + " saiu do servidor", "exit.vanish.receive");
    }
    ...
    public void msg(final PlayerJoinEvent e) {
        ...
        e.setJoinMessage(ChatColor.GREEN + "+ " + ChatColor.RESET + p.getDisplayName() + ChatColor.RESET + ChatColor.WHITE + " entrou no servidor");
