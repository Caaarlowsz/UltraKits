...
public class KitItems implements Listener
{
    ...
    public static void darKit(final Player p, final String kit, final int sopas, final ItemStack[] outros, final ArrayList<String> habilidade) {
        for (final PotionEffect efeito : p.getActivePotionEffects()) {
            p.removePotionEffect(efeito.getType());
        }
        p.getInventory().clear();
        p.getEquipment().setHelmet(new ItemStack(Material.getMaterial(Main.plugin.getConfig().getInt(String.valueOf(kit) + ".helmet.type"))));
        p.getEquipment().setChestplate(new ItemStack(Material.getMaterial(Main.plugin.getConfig().getInt(String.valueOf(kit) + ".chestplate.type"))));
        p.getEquipment().setLeggings(new ItemStack(Material.getMaterial(Main.plugin.getConfig().getInt(String.valueOf(kit) + ".leggings.type"))));
        p.getEquipment().setBoots(new ItemStack(Material.getMaterial(Main.plugin.getConfig().getInt(String.valueOf(kit) + ".boots.type"))));
        p.getInventory().setItem(0, new ItemStack(Material.getMaterial(Main.plugin.getConfig().getInt(String.valueOf(kit) + ".sword.type"))));
        if (!Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".helmet.enchants").isEmpty()) {
            for (final String s : Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".helmet.enchants")) {
                ...
                p.getEquipment().getHelmet().addUnsafeEnchantment(Enchantment.getById((int)Integer.valueOf(e[0])), (int)Integer.valueOf(e[1]));
            }
        }
        if (!Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".chestplate.enchants").isEmpty()) {
            for (final String s : Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".chestplate.enchants")) {
                final String[] e = s.split(" ");
                p.getEquipment().getChestplate().addUnsafeEnchantment(Enchantment.getById((int)Integer.valueOf(e[0])), (int)Integer.valueOf(e[1]));
            }
        }
        if (!Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".leggings.enchants").isEmpty()) {
            for (final String s : Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".leggings.enchants")) {
                final String[] e = s.split(" ");
                p.getEquipment().getLeggings().addUnsafeEnchantment(Enchantment.getById((int)Integer.valueOf(e[0])), (int)Integer.valueOf(e[1]));
            }
        }
        if (!Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".boots.enchants").isEmpty()) {
            for (final String s : Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".boots.enchants")) {
                final String[] e = s.split(" ");
                p.getEquipment().getBoots().addUnsafeEnchantment(Enchantment.getById((int)Integer.valueOf(e[0])), (int)Integer.valueOf(e[1]));
            }
        }
        if (!Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".sword.enchants").isEmpty()) {
            for (final String s : Main.plugin.getConfig().getStringList(String.valueOf(kit) + ".sword.enchants")) {
                final String[] e = s.split(" ");
                p.getInventory().getItem(0).addUnsafeEnchantment(Enchantment.getById((int)Integer.valueOf(e[0])), (int)Integer.valueOf(e[1]));
            }
        }
        if (outros != null) {
