    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String cmd, final String[] args) {
        ...
        if (cmd.equalsIgnoreCase("v")) {
            ...
            if (Main.admin.contains(p.getName())) {
                ...
                Bukkit.broadcastMessage(ChatColor.GREEN + "+ " + ChatColor.RESET + p.getDisplayName() + ChatColor.RESET + ChatColor.WHITE + " entrou no servidor");
                ...
                Bukkit.broadcastMessage(ChatColor.RED + "- " + ChatColor.RESET + p.getDisplayName() + ChatColor.RESET + ChatColor.WHITE + "  saiu do servidor");
            ...
            if (sender.hasPermission("uk.ac")) {
                ...
                for (int length5 = (onlinePlayers5 = Bukkit.getServer().getOnlinePlayers()).length, n2 = 0; n2 < length5; ++n2) {
